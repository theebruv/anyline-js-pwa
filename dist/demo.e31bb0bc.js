...
var _window$anylinejs = window.anylinejs,
    init = _window$anylinejs.init,
    errorCodes = _window$anylinejs.errorCodes;
var viewConfig = {
...
function mountAnylineJS(preset) {
  ...
  Anyline.onResult = function (result) {
    ...
    alert(JSON.stringify(result, null, 2)); // Anyline.stopScanning();
  };

  Anyline.onReport = function (msg) {
    console.log('Report: ', msg);
  };

  Anyline.onDebug = function (msg) {
    alert(JSON.stringify(msg));
  };

  Anyline.onError = function (_ref) {
    var code = _ref.code,
